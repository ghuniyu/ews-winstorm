@extends('layouts.adminmaster')
    ...
    <link rel="stylesheet" type="text/css" href="{{url('assets/css/lib/page_messages.css')}}">
                        ...
                        <div class="panel">
                            <div class="panel-body no-padding">
                                ...
                                <div class="side-bar">  <!--START: Mail Sidebar -->
                                    ...
                                    <div class="action">
                                        <a class="btn btn-success btn-lg btn-block" href="msg-compose.html"><i class="di di-edit"></i> Compose</a>
                                    </div>
                                    
                                    <nav class="folders-wrapper">
                                        <ul class="folders-list list-unstyled">
                                            <li class="active"><a href="msg-inbox.html"><i class="sli-drawer"></i> Inbox (18)</a></li>
                                            <li><a href="msg-inbox.html"><i class="sli-book-open"></i> Draft (3)</a></li>
                                            <li><a href="msg-inbox.html"><i class="sli-action-redo"></i> Sent</a></li>
                                            <li><a href="msg-inbox.html"><i class="sli-trash"></i> Deleted</a></li>
                                        </ul>
                                    </nav>
                                        ...
                                        <ul class="list-mail-item">
                                            ...
                                            <li class="mail-item un-read">
                                                ...
                                                <div class="mail-subject">
                                                    <span class="subject"><a href="msg-mail-view.html">Lorem ipsum dolor noretek imit set.</a></span>
                                                </div>
                                            ...
                                            <li class="mail-item un-read">
                                                ...
                                                <div class="mail-subject">
                                                    <span class="subject"><a href="msg-mail-view.html">Aldus PageMaker including versions of Lorem Ipsum.</a></span>
                                                </div>
                                            ...
                                            <li class="mail-item un-read">
                                                ...
                                                <div class="mail-subject">
                                                    <span class="subject"><a href="msg-mail-view.html">Many desktop publishing packages and web page editors.</a></span>
                                                </div>
                                            ...
                                            <li class="mail-item">
                                                ...
                                                <div class="mail-subject">
                                                    <span class="subject"><a href="msg-mail-view.html">There are many variations of passages of Lorem Ipsum</a></span>
                                                </div>
                                            ...
                                            <li class="mail-item">
                                                ...
                                                <div class="mail-subject">
                                                    <span class="subject"><a href="msg-mail-view.html">The standard chunk of Lorem Ipsum used.</a></span>
                                                </div>
                                            ...
                                            <li class="mail-item">
                                                ...
                                                <div class="mail-subject">
                                                    <span class="subject"><a href="msg-mail-view.html">Contrary to popular belief.</a></span>
                                                </div>
                                            ...
                                            <li class="mail-item">
                                                ...
                                                <div class="mail-subject">
                                                    <span class="subject"><a href="msg-mail-view.html">New UX design class</a></span>
                                                </div>
                                            ...
                                            <li class="mail-item">
                                                ...
                                                <div class="mail-subject">
                                                    ...
                                                    <span class="subject"><a href="msg-mail-view.html">Oor Lorem Ipsum is that it has a more-or-less normal.</a></span>
                                                </div>
